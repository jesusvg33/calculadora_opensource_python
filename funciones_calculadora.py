def sumar_n_numeros():
    numeros_a_sumar = int(input('cuántos numeros quieres sumar: '))
    lista_numeros = []

    for numero in range(0, numeros_a_sumar):
        numero_a_sumar = float(input(f'Ingresar el numero {numero + 1} a sumar'))
...
def multiplicacion_n_numeros():
    resultado = 1
    numeros_a_multiplicar = int(input('cuántos numeros quieres multiplicar: '))
    
    for numero in range(0, numeros_a_multiplicar):
        numeros_a_multiplicar = float(input(f'Ingresar el numero {numero + 1} a multiplicar'))
